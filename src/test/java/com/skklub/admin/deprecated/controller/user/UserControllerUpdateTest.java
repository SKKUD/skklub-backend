package com.skklub.admin.deprecated.controller.user;
    ...
    public void update_success() throws Exception {
        ...
        actions.andExpect(MockMvcResultMatchers.status().isOk())
                ...
                .andDo(document("User-Update"
                        ...
                        ,pathParameters(
                                parameterWithName("userId").description("유저 ID").attributes(RestDocsUtils.example(String.valueOf(0L)))
                        )
                        ,queryParameters(
                                parameterWithName("password").description("변경할 비밀번호").attributes(RestDocsUtils.example(changeTo.getPassword())),
                                parameterWithName("name").description("변경할 유저 이름").attributes(RestDocsUtils.example(changeTo.getName())),
                                parameterWithName("contact").description("변경할 연락처").attributes(RestDocsUtils.example(changeTo.getContact())))
                        ,responseFields(
