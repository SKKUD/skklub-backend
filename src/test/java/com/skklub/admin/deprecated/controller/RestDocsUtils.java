package com.skklub.admin.deprecated.controller;
...
public interface RestDocsUtils {
    ...
    String LINK_SORT_CLUB = "link:common/sorting.html[동아리 정렬,role=\"popup\"]";
    String LINK_SORT_NOTICE = "link:common/sorting_notice.html[공지 정렬,role=\"popup\"]";
    String LINK_SORT_PENDING = "link:common/sorting_pending.html[동아리 요청 정렬,role=\"popup\"]";
    String LINK_ADMIN = "link:common/role_admin.html[어드민 권한,role=\"popup\"]";
    String LINK_NON_USER = "link:common/role_non_user.html[유저 상위 권한,role=\"popup\"]";
